...
public class D1_1 {
    private static Path INPUT_PATH1 = new Path("hdfs://localhost:9000/Demo/D1/input/sales.txt");
    private static Path INPUT_PATH2 = new Path("hdfs://localhost:9000/Demo/D1/input/order.txt");
    private static Path OUTPUT_PATH = new Path("hdfs://localhost:9000/Demo/D1/output1");

    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf);
        job.setJarByClass(D1_1.class);
...
class R1 extends Reducer<Text, ValueBean, Text, NullWritable> {
    @Override

...
public class PartitionCount {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Job job = Job.getInstance(conf, PartitionCount.class.getSimpleName());
        job.setJarByClass(PartitionCount.class);

        job.setInputFormatClass(TextInputFormat.class);
        FileInputFormat.setInputPaths(job, new Path("Partition/in"));
        ...
        FileOutputFormat.setOutputPath(job, new Path("Partition/out"));
